...
each version will reference to Level 3 moodle instructions and my own steps.

Beyond Version 10 were lazily combined into Version - Final that contains enemy_files code and audio, etc.
(can't remember)

Some of the code, I did not follow instructions, I will refer my changes on the README.md files.
See >**Issues** for more details on my personal changes, I will also include my own coding issues there that I could not solve.

## Downloading Code to VSCode:

1.) If you want to download a ZIP for the version you want to try out, I recommend creating a completely
